    ...
    private static readonly IReadOnlyDictionary<Language, IReadOnlyDictionary<string, string>> Values =
        new Dictionary<Language, IReadOnlyDictionary<string, string>>
        {
            [Language.English] = new Dictionary<string, string>
            {
                ...
                ["menu.controlDeviceAuto"] = "Auto (mouse; current: {0})",
                ...
                ["sleep.statusRemainingHoursMinutes"] = "Status: {0} h {1} min remaining",
                ["sleep.statusRemainingMinutes"] = "Status: {0} min remaining",
                ["sleep.statusPausedRemainingHoursMinutes"] = "Status: Paused — {0} h {1} min remaining",
                ["sleep.statusPausedRemainingMinutes"] = "Status: Paused — {0} min remaining",
                ...
                ["timeplan.done"] = "Done",
                ["timeplan.selectedHours"] = "{0} of 168 hours prevent sleep",
                ["timeplan.day.0"] = "Mon",
                ["timeplan.day.1"] = "Tue",
                ["timeplan.day.2"] = "Wed",
                ["timeplan.day.3"] = "Thu",
                ...
                ["input.hookInstallFailed"] = "Input Sharing: input hook unavailable ({0})",
                ...
                ["updates.installedVersion"] = "Installed version: {0}",
                ["updates.version"] = "Version",
                ["updates.released"] = "Released",
                ["updates.currentVersion"] = "{0} (installed)",
                ["updates.loadingHistory"] = "Loading update history...",
                ["updates.noHistory"] = "No update history is available.",
                ["updates.noReleaseNotes"] = "No release notes were provided for this version.",
                ["updates.downloadRelease"] = "Open release download",
                ["updates.historyLoadFailed"] = "Could not load update history.\n\n{0}",
                ["updates.close"] = "Close",
            ...
            [Language.Chinese] = new Dictionary<string, string>
            {
                ...
                ["menu.controlDeviceAuto"] = "自动（鼠标；当前：{0}）",
                ...
                ["sleep.statusRemainingHoursMinutes"] = "状态：剩余 {0} 小时 {1} 分钟",
                ["sleep.statusRemainingMinutes"] = "状态：剩余 {0} 分钟",
                ["sleep.statusPausedRemainingHoursMinutes"] = "状态：已暂停 — 剩余 {0} 小时 {1} 分钟",
                ["sleep.statusPausedRemainingMinutes"] = "状态：已暂停 — 剩余 {0} 分钟",
                ...
                ["timeplan.subtitle"] = "每个方块代表本设备本地时间中一周里的一小时。点击方块可切换，拖动可切换一个矩形区域。更改会即时保存。",
                ...
                ["timeplan.saved"] = "已保存",
                ["timeplan.done"] = "完成",
                ["timeplan.selectedHours"] = "168 小时中有 {0} 小时防止睡眠",
                ["timeplan.day.0"] = "周一",
                ["timeplan.day.1"] = "周二",
                ["timeplan.day.2"] = "周三",
                ["timeplan.day.3"] = "周四",
                ...
                ["input.off"] = "输入共享：关闭",
                ["input.hookInstallFailed"] = "输入共享：输入钩子不可用（{0}）",
                ...
                ["updates.historyTitle"] = "更新历史",
                ["updates.installedVersion"] = "已安装版本：{0}",
                ["updates.version"] = "版本",
                ["updates.released"] = "发布日期",
                ["updates.currentVersion"] = "{0}（已安装）",
                ["updates.loadingHistory"] = "正在加载更新历史...",
                ["updates.noHistory"] = "暂无更新历史。",
                ["updates.noReleaseNotes"] = "此版本未提供更新说明。",
                ["updates.downloadRelease"] = "打开版本下载链接",
                ["updates.historyLoadFailed"] = "无法加载更新历史。\n\n{0}",
                ["updates.close"] = "关闭",
            ...
            [Language.Korean] = new Dictionary<string, string>
            {
                ...
                ["menu.controlDeviceAuto"] = "자동 (마우스; 현재: {0})",
                ...
                ["sleep.statusRemainingHoursMinutes"] = "상태: {0}시간 {1}분 남음",
                ["sleep.statusRemainingMinutes"] = "상태: {0}분 남음",
                ["sleep.statusPausedRemainingHoursMinutes"] = "상태: 일시 중지 — {0}시간 {1}분 남음",
                ["sleep.statusPausedRemainingMinutes"] = "상태: 일시 중지 — {0}분 남음",
                ...
                ["timeplan.saved"] = "저장됨",
                ["timeplan.done"] = "완료",
                ["timeplan.selectedHours"] = "168시간 중 {0}시간이 잠자기를 방지함",
                ["timeplan.day.0"] = "월",
                ["timeplan.day.1"] = "화",
                ["timeplan.day.2"] = "수",
                ["timeplan.day.3"] = "목",
                ...
                ["input.off"] = "입력 공유: 꺼짐",
                ["input.hookInstallFailed"] = "입력 공유: 입력 훅을 사용할 수 없음 ({0})",
                ...
                ["updates.historyTitle"] = "업데이트 기록",
                ["updates.installedVersion"] = "설치된 버전: {0}",
                ["updates.version"] = "버전",
                ["updates.released"] = "릴리스 날짜",
                ["updates.currentVersion"] = "{0} (설치됨)",
                ["updates.loadingHistory"] = "업데이트 기록을 불러오는 중...",
                ["updates.noHistory"] = "사용 가능한 업데이트 기록이 없습니다.",
                ["updates.noReleaseNotes"] = "이 버전에는 릴리스 노트가 없습니다.",
                ["updates.downloadRelease"] = "릴리스 다운로드 열기",
                ["updates.historyLoadFailed"] = "업데이트 기록을 불러올 수 없습니다.\n\n{0}",
                ["updates.close"] = "닫기",
            ...
            [Language.Japanese] = new Dictionary<string, string>
            {
                ...
                ["menu.controlDeviceAuto"] = "自動（マウス；現在：{0}）",
                ...
                ["sleep.statusRemainingHoursMinutes"] = "状態：残り {0} 時間 {1} 分",
                ["sleep.statusRemainingMinutes"] = "状態：残り {0} 分",
                ["sleep.statusPausedRemainingHoursMinutes"] = "状態：一時停止 — 残り {0} 時間 {1} 分",
                ["sleep.statusPausedRemainingMinutes"] = "状態：一時停止 — 残り {0} 分",
                ...
                ["timeplan.done"] = "完了",
                ["timeplan.selectedHours"] = "168 時間中 {0} 時間がスリープを防止します",
                ["timeplan.day.0"] = "月",
                ["timeplan.day.1"] = "火",
                ["timeplan.day.2"] = "水",
                ["timeplan.day.3"] = "木",
                ...
                ["input.off"] = "入力共有: オフ",
                ["input.hookInstallFailed"] = "入力共有: 入力フックを利用できません（{0}）",
                ...
                ["updates.historyTitle"] = "アップデート履歴",
                ["updates.installedVersion"] = "インストール済みバージョン: {0}",
                ["updates.version"] = "バージョン",
                ["updates.released"] = "リリース日",
                ["updates.currentVersion"] = "{0}（インストール済み）",
                ["updates.loadingHistory"] = "アップデート履歴を読み込み中...",
                ["updates.noHistory"] = "アップデート履歴はありません。",
                ["updates.noReleaseNotes"] = "このバージョンにはリリースノートがありません。",
                ["updates.downloadRelease"] = "リリースのダウンロードを開く",
                ["updates.historyLoadFailed"] = "アップデート履歴を読み込めませんでした。\n\n{0}",
                ["updates.close"] = "閉じる",
